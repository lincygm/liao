...
import static com.king.liaoba.util.FileUtil.getRealFilePathFromUri;
...
public class HeadImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void uploadHeadImage() {
        ...
        btnPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //权限判断
                if (ContextCompat.checkSelfPermission(HeadImageActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {
                    //申请READ_EXTERNAL_STORAGE权限
                    ActivityCompat.requestPermissions(HeadImageActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},
    ...
    private void gotoCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(HeadImageActivity.this, BuildConfig.APPLICATION_ID + ".fileProvider", tempFile);
